DROP FUNCTION IF EXISTS authenticated.read_group_member_invitations_of_user();

CREATE OR REPLACE FUNCTION authenticated.read_group_member_invitations_of_user()
    RETURNS table
            (
                id_          uuid,
                group_id_    uuid,
