import {DatabasePostgresOverwritten} from "./supabase.postgres.modified";
 ...
 * */
export type SupabaseObjectReturn<T extends keyof DatabasePostgresOverwritten['postgres']['Functions']> =
    DatabasePostgresOverwritten['postgres']['Functions'][T] extends { Returns: infer R } // Infer the return type
 ...
 * }[]
 */
// export type SupabaseReturn<T extends keyof DatabaseOverwritten['postgres']['Functions']> =
//     DatabaseOverwritten['postgres']['Functions'][T]['Returns']
 ...
 * }
 */
export type SupabaseTable<T extends keyof DatabasePostgresOverwritten['postgres']['Tables']> = DatabasePostgresOverwritten['postgres']['Tables'][T]['Row']
 ...
 */
export type SupabaseEnum<T extends keyof DatabasePostgresOverwritten['postgres']['Enums']> = DatabasePostgresOverwritten['postgres']['Enums'][T];
 ...
 * }
 */
export type SupabaseCompositeType<T extends keyof DatabasePostgresOverwritten['postgres']['CompositeTypes']> = DatabasePostgresOverwritten['postgres']['CompositeTypes'][T];
 ...
 */
export type SupabaseFunctionName = keyof DatabasePostgresOverwritten['postgres']['Functions']
 ...
 * DatabaseGenerated['postgres']['Functions']['T']['Returns'] are not always arrays (in the case of functions that
 ...
 * }
 */
// export type SupabaseArrayReturnConditional<T extends keyof DatabaseOverwritten['postgres']['Functions']> =
//     SupabaseArrayElement<DatabaseOverwritten['postgres']['Functions'][T]['Returns']>;
