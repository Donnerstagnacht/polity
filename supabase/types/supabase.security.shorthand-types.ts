import {DatabaseSecurityOverwritten} from "./supabase.security.modified";
 ...
 * */
export type SupabaseObjectReturn<T extends keyof DatabaseSecurityOverwritten['security']['Functions']> =
    DatabaseSecurityOverwritten['security']['Functions'][T] extends { Returns: infer R } // Infer the return type
 ...
 * }[]
 */
// export type SupabaseReturn<T extends keyof DatabaseOverwritten['security']['Functions']> =
//     DatabaseOverwritten['security']['Functions'][T]['Returns']
 ...
 * }
 */
export type SupabaseTable<T extends keyof DatabaseSecurityOverwritten['security']['Tables']> = DatabaseSecurityOverwritten['security']['Tables'][T]['Row']
 ...
 */
export type SupabaseEnum<T extends keyof DatabaseSecurityOverwritten['security']['Enums']> = DatabaseSecurityOverwritten['security']['Enums'][T];
 ...
 * }
 */
export type SupabaseCompositeType<T extends keyof DatabaseSecurityOverwritten['security']['CompositeTypes']> = DatabaseSecurityOverwritten['security']['CompositeTypes'][T];
 ...
 */
export type SupabaseFunctionName = keyof DatabaseSecurityOverwritten['security']['Functions']
 ...
 * DatabaseGenerated['security']['Functions']['T']['Returns'] are not always arrays (in the case of functions that
 ...
 * }
 */
// export type SupabaseArrayReturnConditional<T extends keyof DatabaseOverwritten['security']['Functions']> =
//     SupabaseArrayElement<DatabaseOverwritten['security']['Functions'][T]['Returns']>;
