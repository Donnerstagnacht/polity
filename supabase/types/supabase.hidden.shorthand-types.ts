import {DatabaseHiddenOverwritten} from "./supabase.hidden.modified";
 ...
 * */
export type SupabaseObjectReturn<T extends keyof DatabaseHiddenOverwritten['hidden']['Functions']> =
    DatabaseHiddenOverwritten['hidden']['Functions'][T] extends { Returns: infer R } // Infer the return type
 ...
 * }[]
 */
// export type SupabaseReturn<T extends keyof DatabaseOverwritten['hidden']['Functions']> =
//     DatabaseOverwritten['hidden']['Functions'][T]['Returns']
 ...
 * }
 */
export type SupabaseTable<T extends keyof DatabaseHiddenOverwritten['hidden']['Tables']> = DatabaseHiddenOverwritten['hidden']['Tables'][T]['Row']
 ...
 */
export type SupabaseEnum<T extends keyof DatabaseHiddenOverwritten['hidden']['Enums']> = DatabaseHiddenOverwritten['hidden']['Enums'][T];
 ...
 * }
 */
export type SupabaseCompositeType<T extends keyof DatabaseHiddenOverwritten['hidden']['CompositeTypes']> = DatabaseHiddenOverwritten['hidden']['CompositeTypes'][T];
 ...
 */
export type SupabaseFunctionName = keyof DatabaseHiddenOverwritten['hidden']['Functions']
 ...
 * DatabaseGenerated['hidden']['Functions']['T']['Returns'] are not always arrays (in the case of functions that
 ...
 * }
 */
// export type SupabaseArrayReturnConditional<T extends keyof DatabaseOverwritten['hidden']['Functions']> =
//     SupabaseArrayElement<DatabaseOverwritten['hidden']['Functions'][T]['Returns']>;
