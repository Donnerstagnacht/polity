...
export class ProfileWikiComponent {
    ...
    protected profile: Signal<SupabaseArrayReturnConditional<'select_user'> | null>;
    protected profileCounter: WritableSignal<SupabaseArrayReturnConditional<'select_following_counter'> | null> = signal(null);
