...
export class ProfileWikiComponent {
    ...
    protected profile: Signal<SupabaseObjectReturn<'select_user'> | null>;
    protected profileCounter: WritableSignal<SupabaseObjectReturn<'select_following_counter'> | null> = signal(null);
