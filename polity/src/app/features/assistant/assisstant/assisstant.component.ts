...
@Component({
    selector: 'polity-assisstant',
    templateUrl: './assisstant.component.html',
    styleUrls: ['./assisstant.component.less']
})
export class AssisstantComponent {
    ...
    async ngOnInit(): Promise<void> {
        const sessionId: string | null = await this.sessionStoreService.sessionId() as string;
        await this.assistantService.selectAssistant(sessionId)
